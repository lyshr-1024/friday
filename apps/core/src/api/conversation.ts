...
import { createConversation, currentConversation, getConversation, latestToday, listConversations } from "../memory/conversations.js";
...
export const conversation = new Hono()
  ...
  .get("/today/latest", (c) => c.json(latestToday() ?? null));
