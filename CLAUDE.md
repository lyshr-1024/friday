...
- 工作台顶部标签：**工作台**（任务板 / 账本，内含首屏横幅「Hello {name}！现在先做什么」可收起）、**AI 热点**。右上角「问 Friday」（`⌘J`）拉出右侧 440px 抽屉承载对话：最近对话下拉、新对话（`⌘N`）、Skill、模型、消息流、输入框（附件粘贴/拖入）。会话历史不再是主体，用户明确"不在意曾经和 Friday 说过什么"。
